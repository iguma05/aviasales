...
export default function Main() {
	...
	const ticketsView = sortByCheckbox(tickets, arrayCountTransfer).slice(
		0,
		countOfView
	);
	...
	return (
		<div className={classes.main}>
			<ul className={classes.main_buttons}>
				{btnFilters.map((btn) => <li key={btn.id}>
						<button
			...
			<button
				className={classes.main_button_more}
				onClick={() => setCountOfView(countOfView + 5)}
			>
